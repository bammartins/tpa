...
public class ContactResourceIT {
    ...
    public void createContact() throws Exception {
        ...
        assertThat(testContact.getContactStatus()).isEqualTo(DEFAULT_CONTACT_STATUS);
        assertThat(testContact.getContactType()).isEqualTo(DEFAULT_CONTACT_TYPE);
        assertThat(testContact.getContactDescription()).isEqualTo(DEFAULT_CONTACT_DESCRIPTION);
    }
    ...
    public void getAllContacts() throws Exception {
        ...
        restContactMockMvc.perform(get("/api/contacts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].contactStatus").value(hasItem(DEFAULT_CONTACT_STATUS.toString())))
    ...
    public void getContact() throws Exception {
        ...
        restContactMockMvc.perform(get("/api/contacts/{id}", contact.getId()))
            ...
            .andExpect(jsonPath("$.contactStatus").value(DEFAULT_CONTACT_STATUS.toString()))
    ...
    public void updateContact() throws Exception {
        ...
        Contact testContact = contactList.get(contactList.size() - 1);
        assertThat(testContact.getContactStatus()).isEqualTo(UPDATED_CONTACT_STATUS);
        assertThat(testContact.getContactType()).isEqualTo(UPDATED_CONTACT_TYPE);
        assertThat(testContact.getContactDescription()).isEqualTo(UPDATED_CONTACT_DESCRIPTION);
    }
