...
public class AttachmentResourceIT {
    ...
    private static final Integer DEFAULT_GCC_ID = 1;
    private static final Integer UPDATED_GCC_ID = 2;
    private static final Integer SMALLER_GCC_ID = 1 - 1;

    private static final String DEFAULT_GCC_NAME = "AAAAAAAAAA";
    private static final String UPDATED_GCC_NAME = "BBBBBBBBBB";
    ...
    public static Attachment createEntity(EntityManager em) {
        Attachment attachment = new Attachment()
            ...
            .gccId(DEFAULT_GCC_ID)
            .gccName(DEFAULT_GCC_NAME);
        return attachment;
    }
    /**
    ...
    public static Attachment createUpdatedEntity(EntityManager em) {
        Attachment attachment = new Attachment()
            ...
            .gccId(UPDATED_GCC_ID)
            .gccName(UPDATED_GCC_NAME);
        return attachment;
    }
    ...
    public void createAttachment() throws Exception {
        ...
        assertThat(testAttachment.getAttachmentName()).isEqualTo(DEFAULT_ATTACHMENT_NAME);
        assertThat(testAttachment.getGccId()).isEqualTo(DEFAULT_GCC_ID);
        assertThat(testAttachment.getGccName()).isEqualTo(DEFAULT_GCC_NAME);
    }
    ...
    public void getAllAttachments() throws Exception {
        ...
        restAttachmentMockMvc.perform(get("/api/attachments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].gccId").value(hasItem(DEFAULT_GCC_ID)))
            .andExpect(jsonPath("$.[*].gccName").value(hasItem(DEFAULT_GCC_NAME.toString())));
    }
    ...
    public void getAttachment() throws Exception {
        ...
        restAttachmentMockMvc.perform(get("/api/attachments/{id}", attachment.getId()))
            ...
            .andExpect(jsonPath("$.gccId").value(DEFAULT_GCC_ID))
            .andExpect(jsonPath("$.gccName").value(DEFAULT_GCC_NAME.toString()));
    }
    ...
    public void updateAttachment() throws Exception {
        ...
        Attachment testAttachment = attachmentList.get(attachmentList.size() - 1);
        assertThat(testAttachment.getAttachmentName()).isEqualTo(UPDATED_ATTACHMENT_NAME);
        assertThat(testAttachment.getGccId()).isEqualTo(UPDATED_GCC_ID);
        assertThat(testAttachment.getGccName()).isEqualTo(UPDATED_GCC_NAME);
    }
